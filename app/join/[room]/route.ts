...
<body>
  <main>
    ...
    <div class="note">Manual controls remain isolated from AI, communications, and diagnostic features so an experimental subsystem failure cannot take down the show controller.</div>
  </main>
</body>
</html>`;
